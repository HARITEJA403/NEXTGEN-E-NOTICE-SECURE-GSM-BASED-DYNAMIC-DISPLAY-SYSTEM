/******************************************************************************
 * File: dot_mat_def.h
 * Description: Contains the 96x8 hex-encoded font array used to render ASCII 
 * characters on the 8x8 dot matrix LED boards.
 ******************************************************************************/
#ifndef DOT_MAT_DEF_H
#define DOT_MAT_DEF_H

// Determines the delay scaling for row multiplexing
#define ROWS 16

// 2D Array mapping ASCII characters to LED pixel data (Cathode driven logic).
// Indexing starts from ASCII 32 (Space character).
